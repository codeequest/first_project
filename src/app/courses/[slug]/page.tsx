          ...
          <div className="grid gap-12 lg:grid-cols-[1.6fr_1fr] lg:gap-16">
            ...
            <aside className="lg:sticky lg:top-28 lg:self-start">
              <div className="flex flex-col gap-6 rounded-2xl bg-white p-7 ring-1 ring-line">
                ...
                {/* Requesting a place is Track B's server action, which has
                    not landed yet. EnrollCta is the session-aware stopgap:
                    it routes signed-out visitors to auth and shows students a
                    disabled placeholder, without touching Track B's files. */}
                <EnrollCta />
